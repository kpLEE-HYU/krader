...
KIWOOM_ERROR_CODES = {
    ...
    -103: "Failed to send order",
    -104: "Unregistered account",
    -105: "Price or quantity data missing",
    -106: "Order type error",
    -107: "Invalid login",
    -200: "Initial failed",
    -201: "Server connection failed",
    -202: "Connection terminated",
    -300: "No quantity for TR",
}
...
class KiwoomBroker(BaseBroker):
    ...
    def _handle_tick_data(self, symbol: str) -> None:
        ...
        try:
            ...
            volume = int(self._ocx.dynamicCall("GetCommRealData(QString, int)", symbol, 15))
